...
public class PlayerCutsceneController2 : MonoBehaviour {

	public float cutsceneTimer;
	public float curCutsceneTimer;

	CutsceneController2 cutCon;
	...
	void Start () 
	{
		...
		cutCon = GameObject.FindGameObjectWithTag("Canvas").GetComponent<CutsceneController2>();
